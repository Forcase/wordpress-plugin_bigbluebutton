...
Wenn Sie sowohl allowStartStopRecording=false als auch autoStartRecording=true setzen, dann wird die gesamte Länge der Sitzung aufgezeichnet, und die Moderatoren in der Sitzung können die Aufzeichnung nicht anhalten/fortsetzen.',
					...
					array(
						...
						'label' => 'meta-origin-server-common-name',
					...
					array(
						...
						'label' => 'meta-recording-description',
					...
					array(
						...
						'type' => 'text',
						'instructions' => 'Standardnummer zum Einwählen via Telefon.',
						'required' => 0,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '',
...
Gültige Werte sind ALWAYS_ACCEPT, ALWAYS_DENY, ASK_MODERATOR.',
					...
					array(
						'key' => 'field_5ed43a495a47e',
						'label' => 'defaultWelcomeMessage',
						'name' => 'bbb_cc_defaultWelcomeMessage',
						'type' => 'wysiwyg',
						'instructions' => 'Standard-Begrüßungsnachricht, die angezeigt wird, wenn der Teilnehmer dem Web beitritt Konferenz. Dies wird nur für die alte Terminplanung verwendet, die
in der Zukunft entfernt werden. Verwenden Sie die API, um eine Konferenz zu erstellen.
Wenn die Nachricht Zeichen enthält, die nicht in ISO-8859-1-Zeichensätzen enthalten sind Sie müssen ordnungsgemäß in Unicode-Zeichen escaped werden. Ein einfacher Weg zu führen Sie dazu die native2ascii-Befehlseinstellung UTF8-Kodierung aus und
den Pfad dieser Datei als Ein- und Ausgabeparameter übergeben, z.B: native2ascii -kodiert UTF8 bigbluebutton.properties bigbluebutton.properties.',
						'required' => 0,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '',
						...
						'default_value' => 'Welcome to <b>%%CONFNAME%%</b>!<br><br>For help on using BigBlueButton see these (short) <a href="event:http://www.bigbluebutton.org/html5"><u>tutorial videos</u></a>.<br><br>To join the audio bridge click the phone button.	Use a headset to avoid causing background noise for others.',
						'tabs' => 'all',
						'toolbar' => 'full',
						'media_upload' => 1,
						'delay' => 0,
					...
					array(
						'key' => 'field_5ed43aae1bd5c',
						'label' => 'defaultMaxUsers',
						'name' => 'bbb_cc_defaultMaxUsers',
						'type' => 'range',
						'instructions' => 'Standardmäßige maximale Anzahl von Benutzern, die eine Besprechung haben kann. Der aktuelle Standardwert ist 0 (die Besprechung hat kein Benutzerlimit).',
						'required' => 0,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '',
					...
					array(
						'key' => 'field_5ed43adb1bd5d',
						'label' => 'defaultMeetingDuration',
						'name' => 'bbb_cc_defaultMeetingDuration',
						'type' => 'number',
						'instructions' => 'Standarddauer der Sitzung in Minuten. Der aktuelle Standardwert ist 0 (die Besprechung endet nicht).',
						'required' => 0,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '',
